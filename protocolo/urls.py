...
urlpatterns = [
                  ...
                  path('instruments/<int:protocol_id>/<int:part_id>/<int:area_id>', views.instruments_view,
                       name="instruments"),
                  ...
                  path(
                      'question/<int:protocol_id>/<int:part_id>/<int:area_id>/<int:instrument_id>/<int:dimension_id>/<int:section_id>',
