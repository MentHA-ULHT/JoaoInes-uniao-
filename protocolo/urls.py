...
urlpatterns = [
                  ...
                  path('protocol-participants/<int:protocol_id>', views.protocol_participants_view, name="protocol-participants"),
                  ...
                  path('instruments/<int:protocol_id>/<int:part_id>/<int:area_id>/<int:patient_id>', views.instruments_view,
                       name="instruments"),
